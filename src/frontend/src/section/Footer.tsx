  ...
  return (
    <footer className="bg-gray-800 text-gray-200 text-center p-6">
      <div className="container mx-auto">
        <h3 className="text-lg font-semibold mb-2">Act Now Against Climate Change</h3>
        ...
        <p className="text-xs">© {new Date().getFullYear()} Climate Action. All rights reserved.</p>
      </div>
    </footer>
  );
};
